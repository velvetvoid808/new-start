...
/* =====================================================
    ...
    function setAccordionState(toggle, expand) {
        ...
        /*
           Keep the accordion's visual state synchronized:
           when closing, the × -> + state and the panel visibility change
           happen in the same event cycle. There is no delayed 500ms hide.
        */
